...
def get_isaac_sim_remappings(mode: NvbloxMode, num_cameras: int,
    ...
    if mode is NvbloxMode.people_segmentation:
        ...
        # 640x480 마스크에 대응하는 원본 CameraInfo
        remappings.append(
            (
...
def add_nvblox(args: lu.ArgumentContainer) -> List[Action]:
    ...
    base_config = lu.get_path('my_people_nvblox_bringup', 'config/nvblox/nvblox_base.yaml')
    segmentation_config = lu.get_path('my_people_nvblox_bringup',
                                      'config/nvblox/specializations/nvblox_segmentation.yaml')
    detection_config = lu.get_path('my_people_nvblox_bringup',
                                   'config/nvblox/specializations/nvblox_detection.yaml')
    dynamics_config = lu.get_path('my_people_nvblox_bringup',
                                  'config/nvblox/specializations/nvblox_dynamics.yaml')
    isaac_sim_config = lu.get_path('my_people_nvblox_bringup',
                                   'config/nvblox/specializations/nvblox_sim.yaml')
    realsense_config = lu.get_path('my_people_nvblox_bringup',
                                   'config/nvblox/specializations/nvblox_realsense.yaml')
    multi_realsense_config = lu.get_path(
        'my_people_nvblox_bringup', 'config/nvblox/specializations/nvblox_multi_realsense.yaml')
    zed_config = lu.get_path('my_people_nvblox_bringup',
