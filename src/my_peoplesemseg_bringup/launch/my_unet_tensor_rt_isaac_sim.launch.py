...
def generate_launch_description():
    ...
    # ShuffleSeg uses a fixed 960x544 NHWC input. The generic encoder also
    # performs rgb8->rgb8 conversion and a 960x544->960x544 crop; both are
    # no-ops for the Isaac Sim stream, so connect resize directly to tensorization.
    resize_node = ComposableNode(
        ...
        remappings=[
            ...
            ('camera_info', '/front_stereo_camera/left/camera_info_plumb_bob'),
        ],
    )
